# Generated by Powerlevel10k configuration wizard on 2020-08-27 at 14:40 AEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS}_FOREGROUND=15
  ...
  vcs+='${${${$(( ${#VCS_STATUS_LOCAL_BRANCH}<=100 )):#0}:+${VCS_STATUS_LOCAL_BRANCH//\%/%%}}'
  ...
  # 42bh if behind the remote.
  vcs+='${${VCS_STATUS_COMMITS_BEHIND:#0}:+ %76F${VCS_STATUS_COMMITS_BEHIND}bh}'
  # 42ah if ahead of the remote; no leading space if also behind the remote: 42bh42ah.
  # If you want '42bh 42ah' instead, replace '${${(M)VCS_STATUS_COMMITS_BEHIND:#0}:+ }' with ' '.
  vcs+='${${VCS_STATUS_COMMITS_AHEAD:#0}:+${${(M)VCS_STATUS_COMMITS_BEHIND:#0}:+ }%76F${VCS_STATUS_COMMITS_AHEAD}ah}'
  # *42 if have stashes.
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      ...
      '*test*'  ENG     # Engineering development site
      '*prod*'  PROD 
      '*live*'  PROD
      '*kind*'  DEFAULT
      '*'       UNKNOWN)
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_VISUAL_IDENTIFIER_EXPANSION=' PRODUCTION SITE '
  typeset -g POWERLEVEL9K_KUBECONTEXT_ENG_FOREGROUND=009
  typeset -g POWERLEVEL9K_KUBECONTEXT_ENG_VISUAL_IDENTIFIER_EXPANSION=' DEV '
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=134
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_KUBECONTEXT_UNKNOWN_FOREGROUND=013
  typeset -g POWERLEVEL9K_KUBECONTEXT_UNKNOWN_VISUAL_IDENTIFIER_EXPANSION=' UNMATCHED SITE '
